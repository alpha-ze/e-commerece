...
export default function ProductsPage() {
  ...
  // ── Local state ───────────────────────────────────────────────────────────
  // Search input has its own controlled state so debounce can work
  ...
  // ── Helpers for updating URL params ──────────────────────────────────────
  ...
  useEffect(() => {
    fetchCategories()
      ...
      .catch(() => {
        // Graceful degradation: filter sidebar just won't show categories
        setCategories([]);
      });
  }, []);
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5 space-y-6 sticky top-6">
              ...
              {hasFilters && (
                <button
                  ...
                  className="w-full text-sm text-indigo-600 hover:text-indigo-500 font-medium text-left"
                >
                  Clear all filters
                </button>
              )}
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center justify-between mb-4 gap-4">
              <div className="flex items-center gap-2 flex-wrap">
                {/* Mobile filter button placeholder — could expand with a drawer */}
